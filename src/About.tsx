...
export const About = () => {
  ...
  return (
    <div id='about' className="container mx-auto w-full h-full mb-32 py-4">
      <p className="magic-text fontC text-xl md:text-5xl bg-black py-5">About me and my journey</p>


      <div className="flex flex-col md:flex-row">

        <div className="bg-primary bg-opacity-70 flex flex-col rounded-xl mx-auto w-2/3">
